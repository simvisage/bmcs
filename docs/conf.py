# -*- coding: utf-8 -*-
#
# BMCS documentation build configuration file, created by
...
root_path_bmcs = os.path.abspath('../')
print('PATH', root_path_bmcs)

sys.path.insert(0, root_path_bmcs)
print('PATH', sys.path)
...
project = 'bmcs'
copyright = '2018, Rostislav Chudoba et al.'
