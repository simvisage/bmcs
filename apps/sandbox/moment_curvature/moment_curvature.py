...
class MomentCurvature(tr.HasStrictTraits):
    ...
    # Number of material points over the cross section
    n_m = tr.Int(200)
    ...
    z_m = tr.Property(depends_on='n_m, model_params_items')
...
mc = MomentCurvature(idx=2, n_m=200)
mc.b = b_
mc.h = h_
