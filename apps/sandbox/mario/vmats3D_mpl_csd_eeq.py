...
#         z_N_Emn = - omegaN * thres_2
    ...
    def get_normal_law(self, eps_N_Emn, omegaN, z_N_Emn, alpha_N_Emn, r_N_Emn, eps_N_p_Emn):
        ...
        eps_N_p_Emn = eps_N_p_Emn + delta_lamda * \
            np.sign(sigma_n_trial - X) / (1.0 - omegaN)
    ...
    def get_tangential_law(self, eps_T_Emna, w_T_Emn, z_T_Emn, alpha_T_Emna, eps_T_pi_Emna, sigma_kk):
        ...
        norm_1 = np.sqrt(
            np.einsum('...na,...na->...n', (sig_pi_trial - X), (sig_pi_trial - X)))
...
#         print '*****'
        ...
        norm_2 = 1.0 * elas_1 + np.sqrt(
            np.einsum('...na,...na->...n', (sig_pi_trial - X), (sig_pi_trial - X))) * plas_1
        ...
        Y = 0.5 * E_T * \
            np.einsum('...na,...na->...n', (eps_T_Emna - eps_T_pi_Emna),
...
#
    ...
    #----------------------------------------------
    def _get_phi_Emab(self, eps_Emab, omegaN, z_N_Emn,
                      alpha_N_Emn, r_N_Emn, eps_N_p_Emn,
                      w_T_Emn, z_T_Emn, alpha_T_Emna, eps_T_pi_Emna):

        phi_Emn = self._get_phi_Emn(eps_Emab, omegaN, z_N_Emn,
                                    alpha_N_Emn, r_N_Emn, eps_N_p_Emn,
                                    w_T_Emn, z_T_Emn, alpha_T_Emna, eps_T_pi_Emna)
    ...
    #(cf. [Jir99], Eq.(21))
    #----------------------------------------------------------------------
    def _get_beta_Emabcd(self, eps_Emab, omegaN, z_N_Emn,
                         alpha_N_Emn, r_N_Emn, eps_N_p_Emn,
                         w_T_Emn, z_T_Emn, alpha_T_Emna, eps_T_pi_Emna):

        delta = np.identity(3)

        phi_Emab = self._get_phi_Emab(eps_Emab, omegaN, z_N_Emn,
                                      alpha_N_Emn, r_N_Emn, eps_N_p_Emn,
                                      w_T_Emn, z_T_Emn, alpha_T_Emna, eps_T_pi_Emna)
...
#
#         beta_ijkl = 0.5 * \
#             (np.einsum('ik,jl -> ijkl', w_mtx, w_mtx) +
...
# sigma_N_Emn)[4]
    ...
    def get_corr_pred(self, eps_Emab_n1, t_n1,
                      alpha_N_Emn, eps_T_pi_Emna,
