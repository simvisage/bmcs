...
#
    ...
    def _get_phi_Emab(self, eps_Emab, omegaN, z_N_Emn,
        ...
        phi_Emn = self._get_phi_Emn(self, eps_Emab, omegaN, z_N_Emn,
                                    alpha_N_Emn, r_N_Emn, eps_N_p_Emn,
                                    w_T_Emn, z_T_Emn, alpha_T_Emna, eps_T_pi_Emna)
    ...
    def _get_beta_Emabcd(self, eps_Emab, omegaN, z_N_Emn,
        ...
        phi_Emab = self._get_phi_Emab(self, eps_Emab, omegaN, z_N_Emn,
                                      alpha_N_Emn, r_N_Emn, eps_N_p_Emn,
                                      w_T_Emn, z_T_Emn, alpha_T_Emna, eps_T_pi_Emna)
...
# sigma_N_Emn)[4]
    ...
    def get_corr_pred(self, eps_Emab_n1,
                      alpha_N_Emn, eps_T_pi_Emna,
                      omegaN, z_N_Emn, sigma_N_Emn, eps_N_p_Emn,
                      r_N_Emn, alpha_T_Emna, w_T_Emn, z_T_Emn):

        beta_Emabcd = self._get_beta_Emabcd(self, eps_Emab_n1, omegaN, z_N_Emn,
                                            alpha_N_Emn, r_N_Emn, eps_N_p_Emn,
                                            w_T_Emn, z_T_Emn, alpha_T_Emna, eps_T_pi_Emna)
